...
<section class="content">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if($JumlahDataPortfolio>0)

            <div class="col-sm-12">
                <div class="alert alert-success" role="alert">Found {{ $JumlahDataPortfolio }}
                    data keyword : {{ $cari }}
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="alert alert-danger" role="alert">Data keyword :
                    {{ $cari }}
                    is not found,
                    <a href="{{url('/portfolio')}}"><input type="button" value="Back" class="btn btn-default" /></a>
                </div>
                @endif
            </div>
            <!-- /.card-body -->
